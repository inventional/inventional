    ...
    <div className="flex h-fit items-center justify-center">
      <section className="relative mb-12 flex h-full w-full overflow-hidden bg-sky-100 py-12 lg:h-[75vh] lg:w-[75vw] lg:rounded-3xl">
        <div className="flex flex-1">
          <BackgroundDecoration className="absolute -right-96 -top-96 z-0 h-[75vh] w-auto origin-top-left" />

          <div className="top-0 z-10 m-auto flex flex-col items-center justify-start gap-8">
